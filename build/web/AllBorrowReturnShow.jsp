...
<html>
    <head>
        ...
        <title>TRANG HIỂN THỊ PHIÊN MƯỢN SÁCH</title>
    ...
    <body>
        ...
        <div>
            <table>
                ...
                <c:forEach var="list" items="${requestScope.listAllBorrowReturnBook}">
                    <c:choose>
                        <c:when test="${list.returnStatus=='Not yet'}">
                            <tr style="background-color: #ff9966;" class="border-rds">
